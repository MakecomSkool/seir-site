...
// Секции после фильма. Текст «Про компанію» — ЧЕРНОВИК: сайт компании пуст,
// заменить абзацем с их материалов.
    ...
    scenes: [
      {
        ...
        duration: 8,
        scrollVh: 100,
        // Фильм открывается первым кадром: ролик и огни городов стартуют с нуля
        // на верху страницы и доигрывают к моменту передачи перебивке.
        scrubWindow: [0, 0.7],
